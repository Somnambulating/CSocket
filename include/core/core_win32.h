...
/* symbol 'rbtree_min' has been defined, but not referenced */
...
#define PTR_SIZE            8
#define SIZE_T_LEN          (sizeof("-9223372036854775808") - 1)
#define MAX_SIZE_T_VALUE    9223372036854775807
#define TIME_T_LEN          (sizeof("-9223372036854775808") - 1)
#define TIME_T_SIZE         8
#define MAX_TIME_T_VALUE    9223372036854775807

#else

#define PTR_SIZE            4
#define SIZE_T_LEN          (sizeof("-2147483648") - 1)
#define MAX_SIZE_T_VALUE    2147483647
#define TIME_T_LEN          (sizeof("-2147483648") - 1)
#define TIME_T_SIZE         4
#define MAX_TIME_T_VALUE    2147483647

#endif


#define OFF_T_LEN           (sizeof("-9223372036854775807") - 1)
